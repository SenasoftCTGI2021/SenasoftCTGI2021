    ...
    <body class="antialiased">
        <div class="items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                ...
                <a href="#" class="btn btn-danger" role="button">Reportar un problema <i class="far fa-bug"></i></a>
                    @auth
                            <a href="{{ url('/home') }}" class="btn btn-primary" role="button">{{ __('Ir a jugar') }}</a>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary" role="button">Ingreso</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-secondary" role="button">Registro</a>
                        @endif
                    @endauth
                </div>
            @endif
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="img/logo.svg" draggable="false" style="width:500px;">
                </div>
